          ...
          in
            pkgs.stdenv.mkDerivation {
              ...
              buildPhase = ''
                ...
                nerd-font-patcher "${outDir}/Iosevka-MediumItalic.ttf" --custom '${self}/Font Awesome 6 Pro-Regular-400.otf' -s --makegroups '-1' --outputdir ${outDir}/../ &
                nerd-font-patcher "${outDir}/Iosevka-Bold.ttf" --custom '${self}/Font Awesome 6 Pro-Regular-400.otf' -s --makegroups '-1' --outputdir ${outDir}/../ &
                nerd-font-patcher "${outDir}/Iosevka-BoldItalic.ttf" --custom '${self}/Font Awesome 6 Pro-Regular-400.otf' -s --makegroups '-1' --outputdir ${outDir}/../ &
                wait
                rm -r ${outDir}
              '';
            };
